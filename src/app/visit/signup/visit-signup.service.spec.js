...
describe('VisitSignupService', () => {
  ...
  beforeEach(() => {
    fakeVisitDates = ['22/06/2017', '15/06/2017'];
  ...
  beforeEach(
    angular.mock.inject(($injector, visitSignupService) => {
  ...
  it('should return user name', () => {
    ...
    mVisitSignupService.findUsers().subscribe(s => {
  ...
  it('should sign up patient to visit', () => {
    ...
    response.respond(201, {
      status: 201,
      data: { message: 'Poprawnie zapisano na wizytę' }
    });

    mVisitSignupService.addVisit().subscribe(s => {
